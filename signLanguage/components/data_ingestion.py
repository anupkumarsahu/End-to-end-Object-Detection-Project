...
class DataIngestion:
    ...
    def download_data(self) -> str:
        try:
            ...
            logging.info("Downloaded data from {dataset_url} into file {zip_file_path}")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            data_ingestion_artifact = DataIngestionArtifact(data_zip_file_path=zip_file_path, feature_store_path=feature_store_path)
